...
<div class="col-md-10">
<a href="mailto:arpit17zambre555@gmail.com" style="color:#000000">arpit17zambre555@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/man.png" width=100 height=100 alt="" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Arpit Zambare</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+918888052164</h4>
		<h4 style="font-family:'typo' ">arpit17zambre555@gmail.com</h4>
		<h4 style="font-family:'typo' ">Pune,Maharashtra</h4></div></div>
		</p>
      </div>
